...
def load_langpair_dataset(
    ...
    print ('\n\n\n\nliwei mark1 max_source_positions ={}\n\n\n\n\n\n'.format(max_source_positions))
    #assert(0==1)
...
class TranslationTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        print ('\n\n\n\nliwei mark2 max_source_positions ={}\n\n\n\n\n\n'.format(self.args.max_source_positions))
        #assert(0==1)
