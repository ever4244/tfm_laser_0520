...
class LaserDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out, lang, incremental_state=None):
        ...
        return self.output_layer(x), attn_scores, {'sentemb':encoder_sentemb}
    ...
    def extract_features(
        ...
        #print ('\nx size = {} encoder_sentemb size = {} l size = {}\n'.format(x.size(),encoder_sentemb.size(),l.size()))
        assert(encoder_sentemb.size()[0]==bsz)
        ...
        return x, None
        #return x, None, encoder_sentemb #liwei mod
