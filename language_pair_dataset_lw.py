...
class LanguagePairDataset(FairseqDataset):
    ...
    def __init__(
        ...
        align_dataset=None,
        append_bos=True, eos=None
    ):
        assert (append_bos==True)
        assert (left_pad_source==False)
        assert (append_eos_to_target==True)
        print ('\n\n\nappend_bos ={} left_pad_source ={} left_pad_target ={} append_eos_to_target={}\n\n\n'.format(append_bos,left_pad_source,left_pad_target,append_eos_to_target))
