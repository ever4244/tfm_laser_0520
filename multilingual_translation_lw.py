...
from .translation_lw import load_langpair_dataset
...
@register_task('multilingual_translation_lw')
class MultilingualTranslationTask_lw(FairseqTask):
    ...
    '''
    append_bos=self.args.append_bos,
    ...
    def build_model(self, args):
        ...
        if not isinstance(model, FairseqMultiModel):
            raise ValueError('MultilingualTranslationTask_lw requires a FairseqMultiModel architecture')
        return model
